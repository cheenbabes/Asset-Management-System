<%-- 
    ...
    Created on : Oct 29, 2014, 10:54:39 AM
    Author     : apprentice
--%>
...
<html>
    ...
    <body>
        <div class="modal fade" id="assetAddNote" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <button type="submit" class="btn btn-primary" onclick="window.location.href = 'login_home.html'">Update Asset</button>
                </div>
            </div>
        </form>
      </div>
